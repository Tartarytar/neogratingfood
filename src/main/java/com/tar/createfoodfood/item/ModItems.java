...
public class ModItems {
    ...
    public static final DeferredItem<Item> APPLE_HONEY_PIE = ITEMS.register("apple_honey_pie",
            () -> new Item(new Item.Properties().food(ModFoodProperties.APPLE_HONEY_PIE)
                    .stacksTo(32).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> BERRY_CHOCO_PIE = ITEMS.register("berry_choco_pie",
            () -> new Item(new Item.Properties().food(ModFoodProperties.BERRY_CHOCO_PIE)
                    .stacksTo(32).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> SWEET_MILK_PIE = ITEMS.register("sweet_milk_pie",
            () -> new Item(new Item.Properties().food(ModFoodProperties.SWEET_MILK_PIE)
                    .stacksTo(32).rarity(Rarity.UNCOMMON)));
